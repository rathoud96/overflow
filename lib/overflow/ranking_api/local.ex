defmodule Overflow.RankingApi.Local do
  @moduledoc """
  Client for the local OpenAI-compatible LLM to rerank answers.
  """
  @llm_url System.get_env("ML_RANKING_URL")
  @timeout String.to_integer(System.get_env("ML_RANKING_TIMEOUT") || "50000")
